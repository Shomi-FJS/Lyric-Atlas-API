...
本Fork项目在上游 [Burial0268/Lyric-Atlas-API](https://github.com/Burial0268/Lyric-Atlas-API) 基础上增加了本地缓存管理机制，用户可以通过 Web 界面查看和管理缓存，同时也支持开发模式下的本地 TTML 文件开发和测试。
...
**TTML 文件格式要求** **[Steve-XMH/amll-ttml-db](https://github.com/Steve-XMH/amll-ttml-db)** **:**
